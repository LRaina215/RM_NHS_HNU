...
MV_CAMCTRL_API bool __stdcall MV_CC_IsDeviceAccessible(
  IN MV_CC_DEVICE_INFO * pstDevInfo,
...
MV_CAMCTRL_API int __stdcall MV_CC_OpenDevice(
  IN void * handle, IN unsigned int nAccessMode,
...
MV_CAMCTRL_API int __stdcall MV_CC_RegisterImageCallBackEx(
  ...
  void(__stdcall * cbOutput)(
    unsigned char * pData, MV_FRAME_OUT_INFO_EX * pFrameInfo,
    void * pUser),
  void * pUser);
...
MV_CAMCTRL_API int __stdcall MV_CC_GetImageForRGB(
  IN void * handle, IN OUT unsigned char * pData,
...
MV_CAMCTRL_API int __stdcall MV_CC_GetImageBuffer(
  IN void * handle, OUT MV_FRAME_OUT * pFrame,
...
MV_CAMCTRL_API int __stdcall MV_CC_DisplayOneFrame(
  IN void * handle,
  IN MV_DISPLAY_FRAME_INFO * pDisplayInfo);
...
MV_CAMCTRL_API int __stdcall MV_CC_GetIntValue(
  IN void * handle, IN const char * strKey,
...
MV_CAMCTRL_API int __stdcall MV_CC_GetIntValueEx(
  IN void * handle, IN const char * strKey,
  OUT MVCC_INTVALUE_EX * pIntValue);
...
MV_CAMCTRL_API int __stdcall MV_CC_ReadMemory(
  IN void * handle, void * pBuffer, int64_t nAddress,
  int64_t nLength);
...
MV_CAMCTRL_API int __stdcall MV_CC_WriteMemory(
  IN void * handle, const void * pBuffer,
  int64_t nAddress, int64_t nLength);
...
MV_CAMCTRL_API int __stdcall MV_CC_RegisterAllEventCallBack(
  void * handle, void(__stdcall * cbEvent)(
    MV_EVENT_OUT_INFO * pEventInfo, void * pUser), void * pUser);
...
MV_CAMCTRL_API int __stdcall MV_GIGE_ForceIpEx(
  IN void * handle, unsigned int nIP,
...
MV_CAMCTRL_API int __stdcall MV_GIGE_SetResend(
  void * handle, unsigned int bEnable,
...
MV_CAMCTRL_API int __stdcall MV_XML_RegisterUpdateCallBack(
  ...
  IN void(__stdcall * cbUpdate)(
    enum MV_XML_InterfaceType enType, void * pstFeature,
